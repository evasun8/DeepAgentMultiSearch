# Objective: Create a Web Search Sub-Agent
# Method 1: Dictionary configuration for DeepAgents
# Integration: Utilizes compiledSubAgent for LangGraph compatibility
